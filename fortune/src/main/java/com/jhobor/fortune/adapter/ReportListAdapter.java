...
public class ReportListAdapter extends ArrayAdapter<ReportBean> {
    Context context;

    public ReportListAdapter(@NonNull Context context) {
        super(context, 0);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.tv_integral.setText(getItem(position).getBillIntegral());
        holder.tv_1.setText(getItem(position).getBillIntegralExplain());
