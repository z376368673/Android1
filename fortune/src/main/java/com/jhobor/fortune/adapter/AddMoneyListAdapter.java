...
public class AddMoneyListAdapter extends ArrayAdapter<AddMoneyBean> {
    Context context;

    public AddMoneyListAdapter(@NonNull Context context) {
        super(context, 0);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.tv_integral.setText(getItem(position).getMoney());
        holder.tv_1.setText(getItem(position).getAmountExplain());
